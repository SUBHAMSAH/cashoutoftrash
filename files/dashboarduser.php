    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php?source=profile"> <?php echo $_SESSION['username'];?></a>
            </div>
            <!-- Top Menu Items -->
...
<b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="dashboarduser.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="dashboarduser.php?source=add_post">Add Post</a>
                            </li>
                            <li>
                                <a href="dashboarduser.php?source=view_post">View All Posts</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="dashboarduser.php?source=view_users"><i class="fa fa-fw fa-table"></i> Users</a>
                    </li>
					
                    <li>
                        <a href="dashboarduser.php?source=comments"><i class="fa fa-fw fa-edit"></i> Comments</a>
                    </li>
                    <li>
                        <a href="dashboarduser.php?source=profile"><i class="fa fa-fw fa-desktop"></i>Profile</a>
                    </li>
					<li>
            ...
            <div class="container-fluid">
               ...
               <?php
						...
						switch($source){
							...
							case 'view_post';
							include "defaultinpostsusers.php";
							break;
							case 'view_users';
							include "defaultinuserstry.php";
							break;
							case 'comments';
							include "defaultincommentsusers.php";
							break;
							case 'profile';
							include "profilepage.php";
							break;
							default:
							 include "dashboardtryuser.php";
						}
						?>
