          ...
          <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="courseArchive_content">
              ...
              <div class="row">
				...
				$news_categories=$row['news_category'];
				?>
				...
				<div class="blogimg_container">
                      <a href="#" class="blog_img">
                        <img alt="img" src="img/<?php echo $news_image ?>">
                      </a>
                    </div>
                    <h2 class="blog_title"><a href="blog-single.html"><?php echo $news_text ?></a></h2>
                    <div class="blog_commentbox">
                      <p><i class="fa fa-user"></i>Richard Remus</p>
                      <p><i class="fa fa-calendar"></i><?php echo $news_date ?></p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="courseArchive_sidebar">
				...
				<li>
                    <div class="media">
                      ...
                      <div class="media-body">
                       <a href="#"><?php echo $news_text ?></a>
                       <span class="feed_date"><?php echo $news_date ?></span>
                      </div>
                    </div>
                  </li>
              ...
              <div class="single_sidebar">
				...
				$news_categories=$row['news_category'];
				?>
                  <li><a href="#"><?php echo $news_categories ?></a></li>
				<?php }
				?>
                </ul>
              </div>
