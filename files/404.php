        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation"> 
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
				...
				?>
				 <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">SmartLife<span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="buyeproduct.php">Smart Health</a></li>
                    <li><a href="#">Smart City</a></li>
                    <li><a href="#">Smart Education</a></li>  
                  <li><a href="#">Smart Life</a></li>
                    <li><a href="#">Smart Health</a></li>					
                  </ul>
                </li>   
              </ul>           
          </div><!--/.nav-collapse -->
