       ...
       <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="title_area">
              <h2 class="title_two">We are Cash Out Of Trash Community</h2>
              <span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span>
              <p>We are the 'CASH OUT OF TRASH' community.We aim to aware people on how to generate income from their waste or use their waste to genenrate income.We also aim to encourage people to buy E-products that they can buy or sell in our website.We are the growing community now.We appreciate useful blogs and photos to our community blog site.</p>
            </div>
          </div>
       </div>
       <div class="row">
         <div class="col-lg-8 col-md-8 col-sm-8">
           <div class="contact_form wow fadeInLeft">
              <form class="submitphoto_form">
                ...
                <textarea name="content"class="wp-form-control wpcf7-textarea" cols="30" rows="10" placeholder="What would you like to tell us"></textarea>
                <input name="submit" type="submit" value="Submit" class="wpcf7-submit">
              </form>
           </div>
         </div>
         <div class="col-lg-4 col-md-4 col-sm-4">
           <div class="contact_address wow fadeInRight">
             ...
             <div class="address_group">
               <p>Near aerodram,Sonari</p>
               <p>Phone: 88844466611</p>
               <p>Email:cashoutoftrash@gmail.com</p>
             </div>
             <div class="address_group">
